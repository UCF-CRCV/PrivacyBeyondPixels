...
if __name__ == '__main__':
    ...
    model = VTN(400).cuda()
    # print(model)
    saved_state_dict = torch.load('../saved_models/VTN_VIT_B_KINETICS.pth')['model_state']
    # print(saved_state_dict['temporal_encoder.embeddings.position_ids'].shape)
    ...
    output, spatial_features = model(rand_input)
    print(output.shape)
