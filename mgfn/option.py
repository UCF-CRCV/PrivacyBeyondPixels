...
def parse_args():
    ...
    parser.add_argument('--params', help='dummy argument')
    parser.add_argument('--feat_extractor', default='mae', choices=['i3d', 'largei3d', 'mae', 'vjepa', 'maev2'])
    parser.add_argument('--feature_size', type=int, default=768, help='size of feature (default: UCF:2048//xd:1024)')
    ...
    parser.add_argument('--batch_size', type=int, default=8, help='number of instances in a batch of data (default: 16)')
    ...
    parser.add_argument('--max-epoch', type=int, default=250, help='maximum iteration to train (default: 100)')
    
    # For UCF.
    parser.add_argument('--rgb-list', default='mgfn/data/ucf-crime.list', help='list of rgb features')
    parser.add_argument('--test-rgb-list', default='mgfn/data/ucf-crime-test.list', help='list of test rgb features')
    parser.add_argument('--datasetname', default='UCF', help='dataset to train on (default:UCF/ST/XD)')
    parser.add_argument('--gt', default='mgfn/data/gt-ucf.npy', help='file of ground truth ')
    ...
    parser.add_argument('--fa_model', default='mae', help='anonymization model path')
